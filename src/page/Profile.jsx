    ...
    return (
        <div className="profile-container">
            ...
            <div className="profile-info">
                ...
                <div className="input-group">
                    ...
                    <input
                        ...
                        readOnly={!editable}
                        onChange={(e) => setProfile({ ...profile, name: e.target.value })}
                        className={`profile-input ${!editable ? 'readonly' : ''}`}
                    />
                </div>
            </div>
            ...
            <div className="button-group">
                {editable ? (
                    <>
                        <button onClick={handleUpdateProfile} className="edit-button save">
                            저장
                        </button>
                        <button onClick={() => setEditable(false)} className="edit-button cancel">
                            취소
                        </button>
                    </>
                ) : (
                    <button onClick={() => setEditable(true)} className="edit-button">
                        수정
                    </button>
                )}
                <button onClick={() => setPasswordModal(true)} className="edit-button password">
                    비밀번호 변경
                </button>
            </div>
            ...
            {passwordModal && (
                <div className="password-modal">
                    ...
                    <div className="button-group">
                        <button onClick={handlePasswordChange} className="edit-button save">
                            비밀번호 변경
                        </button>
                        <button onClick={() => setPasswordModal(false)} className="edit-button cancel">
                            취소
                        </button>
                    </div>
                </div>
